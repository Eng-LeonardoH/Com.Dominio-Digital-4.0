# Programa para ler um número e retornar o mês do ano
# Início do programa
entrada01 = int(input("Digite um número entre 1 e 12: \n"))

if (entrada01 > 12 or entrada01 < 1):
    print("O número digitado foi diferente do orientado no início do programa... Erro")
elif entrada01 == 1:
